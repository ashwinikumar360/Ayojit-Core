...
export default function DocPatramBilling() {
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/billing/create-subscription/docpatram`, {
        method: "POST",
        headers: {
      ...
      const options = {
        ...
        description: "DocPatram Pro Subscription",
      ...
      <div className="min-h-screen bg-zinc-100 flex items-center justify-center font-sans text-black p-6">
        <div className="max-w-md border-4 border-black bg-white p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] text-center">
          ...
          <p className="font-bold text-zinc-700 mt-2">
            Thank you! You now have unlimited access to DocPatram Pro document layout parsing and extraction.
          </p>
    ...
    <div className="min-h-screen bg-zinc-100 flex items-center justify-center font-sans text-black p-6">
      <div className="max-w-md border-4 border-black bg-white p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <div className="mb-4 text-left">
          <a href="/apps/docpatram" className="text-xs font-black underline uppercase">
            ← Cancel
          </a>
        </div>
        ...
        <div className="text-center my-6">
          ...
          <h2 className="text-2xl font-black uppercase mt-2">DocPatram Pro</h2>
          <p className="font-bold text-zinc-600 mt-1">Unlimited Scanned Document Layout Parsing</p>
        </div>
        ...
        <div className="border-2 border-black bg-zinc-50 p-4 mb-6 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
          <ul className="text-sm font-bold flex flex-col gap-2">
            <li>✨ Get unlimited document conversions</li>
            <li>🚀 Zero queue latency (high priority servers)</li>
            <li>💾 Unlimited history dashboard storage</li>
            <li>💳 Flexible ₹999/month plan (cancel anytime)</li>
          </ul>
        </div>
        ...
        <button
          ...
          {loading ? "Processing..." : "Subscribe for ₹999/month"}
        </button>
